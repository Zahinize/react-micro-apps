  ...
  **/
  ...
  return ( 
    <>
      ...
      {renderLapComponent()}
      <button className="alert fs-normal sm mr-10" onClick={handleResetBtnClick}>Reset</button>
      <button className="outline fs-normal sm mr-10" onClick={handleLapBtnClick}>Lap</button>
      <button className="fs-normal sm" onClick={handlePlayBtnClick}>{playText}</button>
    </>
  )
}
